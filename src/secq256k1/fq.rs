...
///
/// is the base field of the secq256k1 curve.
...
mod test {
    ...
    #[test]
    fn test_field() {
        crate::tests::field::random_field_tests::<Fq>("secq256k1 base".to_string());
    }

    #[test]
    fn test_serialization() {
        crate::tests::field::random_serialization_test::<Fq>("secq256k1 base".to_string());
    }
}
