...
pub use ff::{PrimeField, PrimeFieldBits};
use rand::RngCore;
...
///
/// is the scalar field of the secq256k1 curve.
// The internal representation of this type is four 64-bit unsigned
// integers in little-endian order. `Fp` values are always in
// Montgomery form; i.e., Fp(a) = aR mod q, with R = 2^256.
...
const R: Fp = Fp([0x402da1732fc9bebf, 0x4551231950b75fc4, 0x1, 0]);
...
const GENERATOR: Fp = Fp::from_raw([0x07, 0x00, 0x00, 0x00]);
...
mod test {
    ...
    #[test]
    fn test_field() {
        crate::tests::field::random_field_tests::<Fp>("secq256k1 scalar".to_string());
    }

    #[test]
    fn test_serialization() {
        crate::tests::field::random_serialization_test::<Fp>("secq256k1 scalar".to_string());
    }
}
